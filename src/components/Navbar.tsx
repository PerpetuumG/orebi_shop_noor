...
const Navbar: FC = () => {
  ...
  return (
    <header className={'w-full h-20 bg-white border-b-[1px] border-b-gray-400 sticky top-0 z-50'}>
      <nav
        className={
          'h-full max-w-screen-xl mx-auto px-4 xl:px-0 flex items-center justify-between gap-2'
        }
      >
        <Link href={'/'}>
          <Image src={logo} alt={'Orebi'} className={'w-20'} />
        </Link>
        ...
        <div className={'hidden md:inline-flex items-center gap-2'}>
          {navBarList.map(item => (
            <Link
              ...
              underline-offset-4 decoration-[1px] hover:text-gray-950 md:border-r-[2px] border-r-gray-400 duration-200
